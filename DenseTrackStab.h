...
int scale_num = 8;
const float scale_stride = (float)sqrt((float)2);

////////////////////////////////////////////////////////////my param////////////
//char* bb_file = NULL;
//string bb_file("");
string bb_file("../bb_file/HMDB51");
const int classnum = 51;
//const int trainnum = 70;
const int required_num = 8;          // for fisher vector generation and LFDA
...
// parameters for rejecting trajectory  拒绝某条轨迹的参数
const float min_var = (float)sqrt((float)3);  //轨迹最小方差为1.7
const float max_var = 50;                     //轨迹最大方差为50
