...
void loadfile(string &filename, vector<string> &names, int label)
{
	string str;
...
////////////get random num of trainnum to get samples to train fisher vector or compute LFDA///////
void generate_random_nonrepeating_num(int out[])
{
	int a[trainnum] = {0};
